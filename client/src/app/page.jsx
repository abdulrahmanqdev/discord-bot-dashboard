							...
							>
								...
								{status === "authenticated" ? (
									...
									<button
										...
										className="flex items-center justify-center cursor-not-allowed gap-x-2 rounded-xl px-6 py-3 text-white bg-zinc-800 hover:bg-zinc-700 border border-white/10 transition-all shadow-lg"
									>
										<span className="text-base font-medium">Kontrol Paneli</span>
									</button>
								)}
